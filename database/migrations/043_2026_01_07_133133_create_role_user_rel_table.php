...
return new class extends Migration
{
    ...
    {
        Schema::create('role_user_rel', function (Blueprint $table) {
            ...
            $table->index(['organization_id', 'user_id'], 'idx_role_user_rel_org_user');
            $table->index(['user_id'], 'idx_role_user_rel_user_id');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('role_user_rel');
    }
};
